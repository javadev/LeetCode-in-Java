...
class Solution {
    private boolean validWord(String s) {
        ...
        boolean flag1 = c_start == 'a' || c_start == 'e' || c_start == 'i' || c_start == 'o' || c_start == 'u';
        boolean flag2 = c_end == 'a' || c_end == 'e' || c_end == 'i' || c_end == 'o' || c_end == 'u';
        return flag1 && flag2;
    }
    ...
    public int[] vowelStrings(String[] words, int[][] queries) {
        ...
        for (int i = 0; i < queries.length; ++i) {
            ...
            int val = (lower_bound == 0) ? prefix_arr[upper_bound] :
