...
class SolutionTest {
    @Test
    void calcEquation() {
        List<List<String>> equations = new ArrayList<>(Arrays.asList(Arrays.asList("a","b"),Arrays.asList("b","c")));
        double[] values = new double[]{2.0,3.0};
        List<List<String>> queries =
                new ArrayList<>(Arrays.asList(Arrays.asList("a","c"),Arrays.asList("b","a"),
    ...
    @Test
    void calcEquation2() {
        List<List<String>> equations = new ArrayList<>(Arrays.asList(Arrays.asList("a","b"),Arrays.asList("b","c"),Arrays.asList("bc","cd")));
        double[] values = new double[]{1.5,2.5,5.0};
        List<List<String>> queries =
                new ArrayList<>(Arrays.asList(Arrays.asList("a","c"),Arrays.asList("c","b"),
    ...
    void calcEquation3() {
        ...
        List<List<String>> queries =
                new ArrayList<>(Arrays.asList(Arrays.asList("a","b"),Arrays.asList("b","a"),
