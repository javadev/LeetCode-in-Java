...
class SolutionTest {
    ...
    void earliestFullBloom() {
        assertThat(new Solution().earliestFullBloom(new int[]{1,4,3}, new int[]{2,3,1}), equalTo(9));
    }

    @Test
    void earliestFullBloom2() {
        assertThat(new Solution().earliestFullBloom(new int[]{1,2,3,2}, new int[]{2,1,2,1}), equalTo(9));
    }
