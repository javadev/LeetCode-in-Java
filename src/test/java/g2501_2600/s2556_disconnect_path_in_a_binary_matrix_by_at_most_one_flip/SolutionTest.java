...
class SolutionTest {
    ...
    void isPossibleToCutPath() {
        assertThat(new Solution()
                .isPossibleToCutPath(CommonUtils
                        .convertLeetCodeIrregularLengths2DArrayInputIntoJavaArray("[1,1,1],[1,0,0],[1,1,1]")),
                equalTo(true));
    }
    ...
    void isPossibleToCutPath2() {
        assertThat(new Solution()
                        .isPossibleToCutPath(CommonUtils
                                .convertLeetCodeIrregularLengths2DArrayInputIntoJavaArray("[1,1,1],[1,0,1],[1,1,1]")),
                equalTo(false));
    }
}
